    ...
    return (
        <>
            ...
            <img className = "profilePic" src={require("../resources/images/kp-profile-pic.jpg")} alt="profile pic"></img>
                ...
                <p className = "profileLinkedInLink"><a style={{ color: "white" }} href="https://github.com/kurtisp2019/Resume-2019/blob/master/kurtis-pace-resume-2019.pdf">-- Click here to see to my resume --</a></p>
            </div>
        </>
    );
}
