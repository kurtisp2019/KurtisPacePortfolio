    ...
    return(
        <>
            ...
            <img style={{width: "240px", height: "320px", paddingBottom: "25px"}} src={require("../resources/images/temp-profilepic.jpg")} alt="temp pic"></img>
                <p style={{ paddingBottom: "25px", lineHeight: "1.5", fontSize: "22px", marginLeft: "5vw", marginRight: "5vw" }}>I absolutlely 
                <span style={{ fontSize: "26px", fontWeight: "bold" }}> LOVE</span> development of all kinds, I graduated from Full Sail University in 
                        Orlando Florida in 2011 with a bachelors in computer science specifically for Game Development.  The program was
