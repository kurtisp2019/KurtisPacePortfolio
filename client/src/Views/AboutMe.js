    ...
    return (
        <>
            <div className="mainContent aboutMeBackgroundColor">
                ...
                languages like <span className="keyWord"> Asembly x86, XML, HLSL, and GLSL. </span>
                    <br></br>
                    <br></br>
                    Afterwards, I had an 4 month web development internship with a company called GetWebEdge where I learned some<span className="keyWord"> ASP.NET </span> based web dev.
                    <br></br>
                    <br></br>
                    Recently as of May 2019, I completed a coding bootcamp at Denver University for fullstack development using <span className="keyWord">Javascript</span> and learned
